...
import { useResumeStore, type ExperienceEntry } from '@/store/useResumeStore';
...
export default function ExperiencePage() {
    ...
    // Wire to centralized Zustand store
    ...
    return (
        <div className="space-y-6 pb-10">
            ...
            <div className="flex justify-between mt-6 border-t border-border/50 pt-6">
                <Button type="button" variant="secondary" onClick={() => router.push('/resume-builder/summary')} className="gap-2">
                    <ArrowLeft size={16} />
                    Back
                </Button>
                <Button type="button" onClick={() => router.push('/resume-builder/education')} className="gap-2">
                    Save & Next
                    <ArrowRight size={16} />
                </Button>
            </div>
